...
export const analyticsApi = {
  ...
  triggerEod: (date?: string, auto_print = true): Promise<{ telegram_sent: boolean; print_job_id: string }> =>
    apiClient.post('/api/v1/reports/eod', { date, auto_print }).then((r) => r.data),
}
