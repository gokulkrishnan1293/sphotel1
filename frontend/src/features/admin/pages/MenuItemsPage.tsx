...
export function MenuItemsPage() {
  ...
  const [importing, setImporting] = useState(false); const fileRef = useRef<HTMLInputElement>(null)
  ...
  async function handleExport() {
    const a = document.createElement('a'); a.href = URL.createObjectURL(new Blob([await menuApi.exportCsv()], { type: 'text/csv' })); a.download = 'menu.csv'; a.click()
  }
