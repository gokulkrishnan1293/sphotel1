...
async def trigger_eod_flow(db: AsyncSession, tenant_id: str, for_date: date) -> dict:
    '''Orchestrates EOD summary generation, Telegram reporting, and queueing print jobs.'''
